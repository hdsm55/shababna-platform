  ...
  return (
    <section className="py-8 px-4" dir="rtl">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-primary-700">إدارة المقالات</h1>
            ...
            <Card key={blog.id} className="flex flex-col gap-2">
              <div className="flex flex-col gap-3 p-4">
                <div className="flex items-start justify-between gap-2">
                  <h2 className="text-lg font-bold text-primary-700 line-clamp-2 flex-1">
                    {blog.title}
                  </h2>
                </div>
                <div className="flex items-center gap-2 text-xs text-gray-500">
                  <span>بواسطة {blog.author_name || `#${blog.author_id}`}</span>
                  <span>•</span>
                  <span>
                    {blog.created_at
